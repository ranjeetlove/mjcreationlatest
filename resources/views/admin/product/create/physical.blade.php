...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ __('Physical Product') }} <a class="add-btn" href="{{ route('admin-prod-physical-create') }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
											<ul class="links">
												<li>
                        ...
                        @include('includes.admin.form-both')
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Enter Product Sku') }}" name="sku" required="" value="{{ \Illuminate\Support\Str::random(3) . substr(time(), 6, 8) . \Illuminate\Support\Str::random(3) }}
">
