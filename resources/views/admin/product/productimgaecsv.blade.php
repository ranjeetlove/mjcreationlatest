        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('admin-prod-imgae-import') }}">{{ __("Bulk Image Upload") }}</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="add-product-content">
        <div class="row">
            <div class="col-lg-12 p-5">
                ...
                <form id="bulkImageUploadForm" action="{{route('admin-prod-image-importsubmit')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
