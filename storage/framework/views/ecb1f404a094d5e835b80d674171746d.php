					...
					<div class="container-fluid">
						...
						<div class="d-flex justify-content-between">
							...
							<div class="menu-toggle-button">
                                <img src="<?php echo e(asset('assets/images/logo.png')); ?>"  title="admin-logo" style="    height: 80px;
    width: 120px;">
								<a class="nav-link" href="javascript:;" id="sidebarCollapse">
									<div class="my-toggl-icon" style="margin-left: 218px;">
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							<li>
								<a href="javascript:void(0)" class="wave-effect active"><i class="fa fa-home mr-2"></i><?php echo e(__('Dashboard')); ?></a>
							</li>
...
<?php /**PATH D:\xampp\htdocs\Green Coding\newmjcreation\resources\views/layouts/admin.blade.php ENDPATH**/ ?>