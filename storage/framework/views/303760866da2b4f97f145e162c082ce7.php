...
<?php $__env->startSection('content'); ?>
                        ...
                        <?php echo $__env->make('includes.admin.form-both', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="<?php echo e(__('Enter Product Sku')); ?>" name="sku" required="" value="<?php echo e(\Illuminate\Support\Str::random(3) . substr(time(), 6, 8) . \Illuminate\Support\Str::random(3)); ?>
